...
const FEATURE_MAP = {
  ...
  'play area': { slug: 'playground', kind: 'facility', category: 'recreation' },
  'playground': { slug: 'playground', kind: 'facility', category: 'recreation' },
  'restrooms': { slug: 'public-bathroom', kind: 'amenity', category: 'facilities' },
  'restroom': { slug: 'public-bathroom', kind: 'amenity', category: 'facilities' },
  'picnic sites': { slug: 'picnic-tables', kind: 'amenity', category: 'dining' },
  'picnic site': { slug: 'picnic-tables', kind: 'amenity', category: 'dining' },
  'picnic tables': { slug: 'picnic-tables', kind: 'amenity', category: 'dining' },
  'skate park': { slug: 'skate-park', kind: 'park_type', category: 'sports' },
  'skate spot': { slug: 'skate-park', kind: 'park_type', category: 'sports' },
  'football fields': { slug: 'soccer-field', kind: 'facility', category: 'sports' },
  'football field': { slug: 'soccer-field', kind: 'facility', category: 'sports' },
  'soccer fields': { slug: 'soccer-field', kind: 'facility', category: 'sports' },
  'soccer field': { slug: 'soccer-field', kind: 'facility', category: 'sports' },
  'basketball courts': { slug: 'basketball-court', kind: 'facility', category: 'sports' },
  'basketball court': { slug: 'basketball-court', kind: 'facility', category: 'sports' },
  'basketball hoops': { slug: 'basketball-court', kind: 'facility', category: 'sports' },
  'baseball fields': { slug: 'baseball-field', kind: 'facility', category: 'sports' },
  'baseball field': { slug: 'baseball-field', kind: 'facility', category: 'sports' },
  'softball fields': { slug: 'baseball-field', kind: 'facility', category: 'sports' },
  'softball field': { slug: 'baseball-field', kind: 'facility', category: 'sports' },
  'baseball/softball fields': { slug: 'baseball-field', kind: 'facility', category: 'sports' },
  'walking trail': { slug: 'walking-trail', kind: 'facility', category: 'trails' },
  'walking trails': { slug: 'walking-trail', kind: 'facility', category: 'trails' },
  'bike trail': { slug: 'bike-trail', kind: 'facility', category: 'trails' },
  'bike trails': { slug: 'bike-trail', kind: 'facility', category: 'trails' },
  'fishing': { slug: 'fishing', kind: 'facility', category: 'recreation' },
  ...
  'dog park': { slug: 'dog-park', kind: 'park_type', category: 'animals' },
  'dog off-leash area': { slug: 'dog-park', kind: 'park_type', category: 'animals' },
  'off-leash dog area': { slug: 'dog-park', kind: 'park_type', category: 'animals' },
  'wheelchair access': { slug: 'wheelchair-access', kind: 'accessibility', category: 'access' },
  'wheelchair accessible': { slug: 'wheelchair-access', kind: 'accessibility', category: 'access' },
  'ada playground': { slug: 'ada-playground', kind: 'accessibility', category: 'access' },
  'shade trees': { slug: 'shade-trees', kind: 'environment', category: 'landscape' },
  'community garden': { slug: 'community-garden', kind: 'environment', category: 'environment' },
  'bbq grills': { slug: 'bbq-grills', kind: 'amenity', category: 'dining' },
  'bbq': { slug: 'bbq-grills', kind: 'amenity', category: 'dining' },
  'barbecue': { slug: 'bbq-grills', kind: 'amenity', category: 'dining' },
  'barbecues': { slug: 'bbq-grills', kind: 'amenity', category: 'dining' },
  'benches': { slug: 'benches', kind: 'amenity', category: 'seating' },
  'drinking fountain': { slug: 'drinking-fountain', kind: 'amenity', category: 'water' },
  'drinking fountains': { slug: 'drinking-fountain', kind: 'amenity', category: 'water' },
  'parking': { slug: 'parking', kind: 'amenity', category: 'access' },
  'wifi': { slug: 'wifi', kind: 'amenity', category: 'tech' },
  'multi-use courts': { slug: 'volleyball-court', kind: 'facility', category: 'sports' },
  'pickleball court': { slug: 'pickleball-court', kind: 'facility', category: 'sports' },
  'pickleball courts': { slug: 'pickleball-court', kind: 'facility', category: 'sports' },
};
