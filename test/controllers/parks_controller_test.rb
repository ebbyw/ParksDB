...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { parkAddress: @park.parkAddress, parkHours: @park.parkHours, parkName: @park.parkName, parkWebsite: @park.parkWebsite } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { parkAddress: @park.parkAddress, parkHours: @park.parkHours, parkName: @park.parkName, parkWebsite: @park.parkWebsite } }
